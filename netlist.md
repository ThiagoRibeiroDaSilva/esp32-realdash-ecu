...
PASSO 9.1: SENSOR DE NÍVEL DO RADIADOR (XKC-Y25-NPN + PC817 IC3)
• Pads do Chicote Externo (Onde você solda os fios que vão para o motor):
• H12: Soldar o Fio Amarelo (Sinal OUT do Sensor).
• H13: Soldar o Fio Azul (GND) junto com o Fio Preto (Modo SENS). [JUMPER flexível do H13 p/ PGND (H2)].
• H14: Soldar o Fio Marrom (VCC 5V). [PONTE do H14 p/ Trilha 5V_D (H16)].
• Optoacoplador IC3 (PC817): * Pinos nas Colunas K e N (Linhas 12 e 13).
• Pino 1 (K12): R 2.2k conectando o H12 (Pad do Sinal) ao K12.
• Pino 2 (K13): [JUMPER flexível do K13 p/ PGND (K2)].
• Pino 3 (N13): [JUMPER flexível do N13 p/ LGND (N48)].
• Pino 4 (N12): [JUMPER flexível do N12 p/ GPIO7 do ESP (P26)].
• R 10k (Pull-up): Pernas no N12 e N15. [JUMPER flexível do N15 p/ Trilha 3.3V_ESP (N44)].
